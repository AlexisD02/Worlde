...
class FileHandler:
    def __init__(self, file_with_words_path):
...
def sort_frequencies(words: [str], command: [str]):
    """
...
def find_matched_words(words: [str], grays: [str], yellows: {}, greens: {}, command: [str]):
    """
...
def wordle_demo(words_list: [list]):
    sort_frequencies(words_list, "print")
    print()
    ...
    print(find_matched_words(words_list, ['i', 'o', 'u', 'l', 'd', 'w', 't'], {'s': {1, 2}, 'p': {3}}, {'s': {0}, 'a': {2}}, "word"))
    print(find_matched_words(words_list, ['m'], {'p': {2, 3}, 'd': {0}}, {'a': {1, 4}}, "word"))
    print(find_matched_words(words_list, ['a', 'e', 'i', 'o', 'u', 'y', 'r', 'w', 't'], {}, {}, "word"))
    print()
...
class WordleGame:
    ...
    def main_game(self):
        ...
        while True:
            random_word = random.choice(self.words_list)  # choose a secret word from the text file "wordles.txt"
            num_of_guesses = 0
            ...
            if start_input == '1':  # we use a continuous loop, since there could be a number
                ...
                s_words = find_words_with_letters(self.words_list, sort_frequencies(self.words_list, "returntopfive"))
...
if __name__ == '__main__':  # main program
    ...
    validator = WordValidator(words_list)
